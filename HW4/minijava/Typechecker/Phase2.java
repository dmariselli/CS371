...
/*  TODO: Things we do not understand:
    #7 (Access)- A variable that holds the return value.  When the code hits a return insert the value of the return into the
    ...
    Make sure all Label creations are done through Machine.makeLabel()???--READ THE THING
    ...
    Inititalize HiddenVar with allocAccess
...
public class Phase2
{
    ...
    void process(AMethodMaindecl n) {
        ...
        new MEM(method.getHidden().getAccess().exp(new TEMP(method.getFrame().FP())));
